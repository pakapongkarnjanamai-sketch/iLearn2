...
5. **การจองเลขแผน:** ก่อนสร้าง `PLAN-NNN` ใหม่ ต้องหาเลขสูงสุดจากไฟล์จริงใน `DOC/PLANS/` (**รวมไฟล์ uncommitted ของ agent อื่น**) แล้วใช้เลขถัดไป — ถ้าชนกัน ใครสร้างก่อนได้เลขไป ตัวหลังย้ายเลข (กติกาเต็มใน `DOC/PLANS/README.md`)
