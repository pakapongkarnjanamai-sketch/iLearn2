(function (window, $) {
    ...
    const noDataMessages = {
        ...
        learners: 'No learners found.',
        'learner groups': 'No Learner Groups found.',
        contentItems: 'No content items found.',
        content: 'No content added yet. Click buttons above to add.',
        unusedPublishedContentItems: 'No unused published content found.',
        draftContentItemsNeeded: 'No draft content needed by active courses.'
    };
    const toastIconMap = {
    ...
    function applyAdminCombinedFilter(gridInstance, conditions) {
        if (!gridInstance) {
            return;
        }
    ...
    function initAdminCourseFiltersFallback(options) {
        const opts = options || {};
        ...
        function applyCourseFilters() {
            ...
            applyAdminCombinedFilter(grid, conditions);
        }
        ...
        $(clearSel).off('click.adminCourseFilters').on('click.adminCourseFilters', function () {
    ...
    function initAdminLearnerOrgFiltersFallback(options) {
        const opts = options || {};
        ...
        function applyFilters() {
            ...
            applyAdminCombinedFilter(grid, filters);
        }
        ...
        $(clearSel).off('click.adminLearnerOrgFilters').on('click.adminLearnerOrgFilters', function () {
    ...
    window.applyCombinedFilter = typeof window.applyCombinedFilter === 'function'
        ? window.applyCombinedFilter
        : applyAdminCombinedFilter;
    window.initAdminCourseFilters = typeof window.initAdminCourseFilters === 'function'
        ? window.initAdminCourseFilters
        : initAdminCourseFiltersFallback;
    window.initAdminLearnerOrgFilters = typeof window.initAdminLearnerOrgFilters === 'function'
        ? window.initAdminLearnerOrgFilters
        : initAdminLearnerOrgFiltersFallback;
