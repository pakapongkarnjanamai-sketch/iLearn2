  ...
  return (
    <div className="flex min-h-screen bg-slate-50/60">
      ...
      <main className="flex flex-1 min-w-0 flex-col min-h-screen">
        ...
        />
        <div className="flex h-[calc(100vh-56px)] min-h-0 flex-col gap-4 short:gap-3 overflow-auto p-4 px-5 pb-5 short:p-3 short:px-4 short:pb-3 bg-slate-50/60 has-[.wizard-surface]:overflow-hidden has-[.wizard-surface]:bg-slate-50/60 print:h-auto print:overflow-visible print:bg-white">
          <Outlet />
        </div>
      </main>
    </div>
